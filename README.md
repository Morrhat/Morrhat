...
- Опыт, полученный на стажировках и стартап-проектах, включает:
  ...
  - Тестирование платформы для конструирования AI-ассистентов, тестирование процесса создания AI-ассистентов.
...
- Сейчас активно развиваюсь в направлении тестирования и готова применить свой опыт и новые знания в IT-сфере.
  ...
  - Тестирование — Функциональное/Интеграционное (API, микросервисы), Мобильное (Android), Веб-приложений, Исследовательское, UI/UX, Кросс-браузерное
  ...
  - Базы данных — PostgreSQL (сложные запросы), Redis (кэширование), ClickHouse (анализ данных), SQL (DBeaver), MongoDB
  - Процессы — Анализ требований, Регрессионное тестирование, Работа с логами (adb logcat)
  - Программирование - Visual Studio Code, основы языков программирования Python и HTML

### 🐱‍🐉 Fun fact: 
- 🐱‍👤 Меня вырастили коты и компьютерные игры
- Проработала 7 лет на производстве, так что могу сказать: «На <strong>заводе</strong> уже была»
...
---
### 🧧 Резюме
- С моим резюме можно ознакомиться ✨ [здесь](https://drive.google.com/file/d/1UR6BS_ihDBxZhf881MlrZy1ROk79j9hK/view?usp=drive_link) ✨
- Резюме на HH.ru ✨ [здесь](https://spb.hh.ru/resume/c6fff257ff0f316d3f0039ed1f4e57314e4c69) ✨
---
...
<table>
      <tr>
       ...
       <tr>
        ...
        <td>
          ● Провела сравнительное тестирование LLM (OpenAI, Anthropic Claude, DeepSeek-RL) по производительности
и функциональности моделей, по точности ответов на 80+ тестовых промптов;<br>
● Тестировала E2E процесс создания и настройки ассистентов, включая конфигурацию системных промптов,
составление и загрузка баз знаний, интеграция API, настройки личности и параметров модели, развертывание n8n;<br>
● Спроектировала и реализовала 50+ тест-кейсов для проверки различных промптов и тестовых сценариев для
ИИ моделей. Выявила 10+ дефектов (ошибка загрузки файлов, дефекты интерфейса).<br>
    ...
    <tr>
        ...
        <td>
● Проводила ручное функциональное, исследовательское тестирование веб-приложения(backend), а также
интеграционное тестирование между микросервисами; <br>
● Тестировала REST API через Postman и документации в Swagger: создала коллекцию из 80+ сценариев (GET,
POST, PUT, DELETE, PATCH), валидация JSON-схем, статус-кодов (200, 201, 204, 400, 401, 403, 404, 405, 422);<br>
● Тестировала UI/UX: валидация 10+ сложных форм, навигацию, кросс-браузерная совместимость (Chrome,
Firefox, Yandex);<br>
● Разработала чек-листы для позитивных/негативных сценариев, включая регистрацию, авторизацию, эквивалентное разбиение и
граничные значения, управление заказами и управления учетными записями через API;<br>
● Проанализировала 20+ эндпоинтов в Swagger, выявила 12 несоответствий документации.<br>
        </td>
       </tr>   
  <tr>
           <td>3</td>
        ...
        <td>
● Проводила функциональное, интеграционное и usability-тестирование мобильного приложения, фокусируясь
на ключевых рабочих процессах: создание заказа, навигация по карте, обновление статусов доставки. Результат:
Выявила 19 дефектов (включая 3 связанных с работой с интеграцией карт);<br>
● Проверяла интеграцию мобильного приложения с сервисом картографии Yandex Maps, интерактивность
карты, масштабирование, отзывчивость маркеров, время отклика, удобство работы с картой с разными
разрешениями экрана и версиями Android;<br>
● Проверила 15+ ключевых сценариев: создание заказа (валидация формы, выбор опций), смена статусов
доставки («Создано» → «Принято курьером»), отмена заказа, истечение времени заказа.<br>
        </td>
       </tr>
      <tr>
           <td>4</td>
        ...
        <td>
        ● Проводила тестирование методом черного ящика после редизайна интерфейса приложения, делая акцент на верстку, удобство использования и соответствии нового дизайна требованиям пользователей;<br>
● Проводила функциональное тестирование мобильного приложения, фокусируясь на ключевых пользовательских сценариях, включая регистрацию, создание и оформление заказа;<br>
● Проводила тестирование каталога товаров методом попарного тестирования для проверки всех возможных комбинаций значений каждой пары входных параметров.<br>
        </td>
       </tr> 
        <tr>
           <td>5</td>
        <td>"System Store Manager" - платформа-практикум TestGrow.ru</td>
        <td>07/2025 — н.в.</td>
        <td>
        ● Задачи в тренажере устроены как в настоящей рабочей среде. После третьего раздела начинается выполнение автоматических заданий на реальной платформе интернет-магазина.
        </td>
       </tr> 
</table>
...
<table>
     ...
     <tr>
        ...
        <td>08/2025</td>
        <td>
        <a href= "https://drive.google.com/file/d/1oe41oqoVvY16SJ9ZWpo4TNZEvrNZvnca/view?usp=drive_link"><img title="api_autotest_en" src="https://img.icons8.com/?size=100&id=NKgZQ1HcnM3s&format=png&color=000000" width="40" height="40" alt="backend"/></a>
        </td>
      </tr>  
</table>
