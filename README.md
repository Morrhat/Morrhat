...
- Fullstack QA Engineer (Manual, Automation) с практическим опытом тестирования веб, мобильных приложений и backend (API, микросервисы, БД).

- Стек: Python, Pytest, SQL, Postman, Swagger, REST API, Docker, Git, Bash, Android Studio, Charles Proxy, Chrome DevTools, MongoDB, ClickHouse, Redis, CI/CD, XML, JSON.
...
#### 🐱‍💻  Опыт, полученный на стартап-проектах, включает:
...
### 🐱‍👤 План на ближайшее время:
  - Углубить экспертизу в автоматизации API (GraphQL, gRPC), CI/CD пайплайнах (Jenkins, GitLab CI);
  - Изучить Kafka/RabbitMQ для тестирования асинхронных процессов;
  - Усилить навыки в разработке сложных SQL-запросов, тестировании NoSQL (MongoDB) и масштабируемых систем.

### 🐱‍🐉 Fun fact: 
- 🐱‍👤 Меня вырастили коты и компьютерные игры
- Выросла среди котов — мастеров непредсказуемого поведения. Коты отточили мой навык исследовательского тестирования и чутьё предвидеть аномалии: вижу паттерны там, где другие видят хаос.
- Любовь к играм — ловлю баги с методичностью Геральта из Ривии: исследую 'местность' (логи), изучаю 'бестиарий' (документацию), готовлю 'зелья' (тест-кейсы) и применяю нужный 'знак' (инструмент).
- Проработала 7 лет на производстве, так что могу сказать: «На <strong>заводе</strong> уже была»
- 7 лет на производстве научили меня: качество — это не случайность, а системный процесс, выстроенный до мелочей. Качество продукта = качество процессов.
...
интеграционное тестирование между микросервисами.
        </td>
       </tr>   
  <tr>
           <td>3</td>
...
на ключевых рабочих процессах: создание заказа, навигация по карте, обновление статусов доставки.
        </td>
       </tr>
      <tr>
           <td>4</td>
        ...
        <td>
        ● Проводила тестирование методом черного ящика после редизайна интерфейса приложения, делая акцент на верстку, удобство использования и соответствии нового дизайна требованиям пользователей.
        </td>
       </tr> 
        <tr>
           <td>5</td>
