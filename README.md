...
● Проводила функциональное тестирование мобильного приложения, фокусируясь на ключевых пользовательских сценариях, включая регистрацию, создание и оформление заказа;
● Проводила тестирование каталога товаров методом попарного тестирования для проверки всех возможных комбинаций значений каждой пары входных параметров.
        </td>
       </tr> 
</table>
